...
public class FrontController extends HttpServlet {
    ...
    public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        String requestedAction = request.getParameter("action"); //from Action
        ...
        if (requestedAction == null) {
            ...
            try {
                ...
                session.setAttribute("books", books); //Fixed attribute name from Books to book
            ...
            this.dispatch(request, response, nextPage);
        } else if (requestedAction.equals("checkout")) { //changed from Checkout
